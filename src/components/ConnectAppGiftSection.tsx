...
const features: FeatureTour[] = [
  ...
  },
  {
    id: 'places',
    icon: MapPin,
    title: 'Safe Arrival Places & Geofencing',
    badge: 'Safety & Peace of Mind',
    summary: 'Add your important places (Home, Work, Gym, Travel) with smart arrival alerts so she always knows you reached safely without having to ask or worry.',
    details: 'Automatic departure & arrival notifications ("Reached safely! 🏡") with custom geofenced radius so she never has to stress or worry when you are on the road or traveling.',
    screenTitle: 'Safe Arrival Detection',
    screenSubtitle: 'Auto Alert: Akhil reached Home safely 🏡',
    screenEmoji: '🛡️',
    accentGradient: 'from-emerald-500 via-teal-500 to-blue-500',
  },
  {
    id: 'history',
    icon: History,
